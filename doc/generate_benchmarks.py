...
larson_throughput = {
    'Hoard': [55.5, 31.1, 53.0, 84.0, 157.6, 291.3, 550.3, 1094.9, 1646.0, 1793.2],
    'mimalloc': [53.1, 31.0, 37.9, 59.0, 110.2, 207.9, 429.6, 917.9, 1186.8, 1346.1],
    'jemalloc': [53.4, 30.6, 38.4, 58.3, 106.5, 211.7, 429.1, 924.2, 1187.7, 1350.7],
    'glibc': [52.4, 30.7, 37.0, 60.1, 106.8, 208.7, 416.6, 873.1, 1186.9, 1338.2],
}
larson_mem = {
